...
namespace CANStudio.BulletStorm.Storm
{
    ...
    {
        private readonly IReadOnlyDictionary<string, IBullet> bulletSystemDictionary;
        private readonly List<IBullet> bulletSystemList = new List<IBullet>();
        private readonly IBullet defaultBullet;
        ...
        public StormInfo([NotNull] IReadOnlyDictionary<string, IBullet> bulletSystems,
            [NotNull] IBullet defaultBullet)
        {
        ...
        public IEnumerator Execute(Transform emitter)
        {
            ...
            for (var i = 0; i < defaultBulletSystemList.Count; i++)
                defaultControllers.Add(defaultBullet.GetController());
